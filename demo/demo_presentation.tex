...
\label{sec:org45c4f75}
\begin{frame}[label={sec:org2e6fba1},fragile]{What is the \texttt{pittsburgh} template?}
...
\begin{frame}[label={sec:orgf10487a},fragile]{Why?}
...
\label{sec:orgb388f18}

\begin{frame}[label={sec:org4f679a1}]{Cool feature I: \emph{Pretty text boxes}}
\widen[1cm]{
...
\begin{frame}[label={sec:orgc0117a7},fragile]{Cool feature II: \emph{Adjustable width}}
...
\begin{frame}[label={sec:orgb7416f2}]{}
\centering
Have fun!
\end{frame}
