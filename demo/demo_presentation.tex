...
\begin{frame}{What is the \texttt{pittsburgh} template?}
 \texttt{pittsburgh} is a beamer template based on the widely used \texttt{metropolis} theme.

It's called \texttt{pittsburgh} because Pittsburgh, PA is the metropolis where this was made.
\end{frame}
...
\pause
\end{enumerate}
Beamer fixes the above and \texttt{pittsburgh} attempts to carry over some of the slick design of Keynote.
\end{frame}
...
\begin{frame}{Cool feature II: \emph{Adjustable width}}
